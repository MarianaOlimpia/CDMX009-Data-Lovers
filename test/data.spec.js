...
describe('getAllNews', () => {
  test('Debería recibir todos los títulos contenidos en expected sin importar si hay adicionales', () => {
    ...
    },
    {
      ...
      is_external_url: true,
      img: 'https://steamcdn-a.akamaihd.net/steam/apps/440/header.jpg?t=1577610485',
      author: '',
    ...
    },
    {
      ...
      is_external_url: true,
      img: 'https://d2skuhm0vrry40.cloudfront.net/2018/articles/2018-10-25-11-28/menu.jpg',
      author: '',
    ...
    },
    {
      ...
      is_external_url: true,
      img: 'https://assets.rockpapershotgun.com/images/2018/10/ScreamFortressX.jpg/RPSS/resize/760x-1/format/jpg/quality/90',
...
describe('filterNewsByFeedname', () => {
  test('deberia devolver los titulos con feedname rps', () => {
    expect(filterNewsByFeedname('rps')).toEqual([
      {
        gid: '2403126706534048982',
        title: 'All of Halloween is happening in TF2 s Scream Fortress X',
        url: 'https://steamstore-a.akamaihd.net/news/externalpost/rps/2403126706534048982',
